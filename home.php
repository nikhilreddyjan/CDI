...
<div class="simblaEL containerHolder" data-drag="P0" id="P0" style="padding-bottom:-30px;">
...
<font face="Arial">Sign up now to be even closer.</font></span></div></h2></div></div>
...
<div class="row simblaEL rDivider" data-drag="P22" id="P22" data-border-type="All" style="position: relative; padding: 15px 15px 35px;padding-top:10px; border-radius: 5px; background-color: rgb(255, 255, 255); top:-65px;" data-title="Row">
...
<input type="text" class="form-control" name="fullname" id="P25" placeholder="Fullname" value="<?php echo $fullname; ?>" required> </div>
<div class="simblaEL form-group" data-drag="P26" id="P26">

<div class="simblaEL form-group" data-drag="P26" id="P26">
<label for="P25" style="display: none;"></label>
<input type="text" class="form-control" name="htno" id="P25" placeholder="HallTicket Number"  value="<?php echo $htno; ?>"required> </div>
<label for="P25" style="display: none;"></label> 
<!--<input type="text" class="form-control" name="branch" id="P25" placeholder="Branch(IT,CSE,ECE...)" value="<?php/* echo $branch;*/ ?>" required> </div>-->
<select name="branch" onchange="javascript:setTimeout(&#39;__doPostBack(\&#39;coursePref3\&#39;,\&#39;\&#39;)&#39;, 0)" id="branch" class="form-control" >
...
<div class="simblaEL form-group" data-drag="P26" id="P26">
<label for="P25" style="display: none;"></label>
<input type="text" class="form-control" name="email" id="P25" placeholder="Email-ID" value="<?php echo $email; ?>" required> </div>
<div class="simblaEL form-group" data-drag="P30" id="P30">
<label for="P29" style="display: none;"></label>
<input type="email" class="form-control" name="phno" id="P29" placeholder="Phone Number"  value="<?php echo $phno; ?>"required> </div>
<div class="simblaEL form-group" data-drag="P34" id="P34" style="position: relative; padding-bottom: 20px;">
<label for="P33" style="display: none;"></label>
<input type="password" class="form-control" name="pwd" id="P33" placeholder="Password"  value="<?php echo $pwd; ?>"required> </div>
<button type="submit" class="simblaEL btn btn-block" data-drag="P36" id="P36" name="submit1">Sign Up</button></div></div></div></div></div></div></div></div>
</form>
<div class="simblaEL  simblaBlock footerBlock footer4 containerHolder" data-drag="P37" id="P37" style="position: relative;">
<div class="container main" style="width: 100%; padding-top: 0px; padding-bottom:0px; background-color: rgb(125, 120, 120); border-radius: 0px;" data-border-type="All">
<div style="color:white; max-width:100%;font-size:18px; background-color:#grey; text-align:center; position: relative;bottom:0px;  padding:26px;margin-top:2px;">
&copy;Anurag Group of Institutions, 2018 || <strong>Courtesy</strong>: Dept. of Information Technology
</div>
