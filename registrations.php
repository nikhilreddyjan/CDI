...
$search_result='';
	...
	if ($_SESSION['logid']!='logid')
	{
		$SESSION['msg'] = "You don't have permission to access this file";
...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM register WHERE branch = '$branch'";
    $search_result = filterTable($query);
    //SELECT * FROM stud_info WHERE Program_admitted like '%".$coursePref3."%'(search query)
}
 else {
	 error_reporting( 0 );
...
<body>
  ...
  <tr>
 <td style="padding:8px;padding-bottom:100px;height:500px;width:20%;border-right:1px solid black;">
<?php include("left.php");?>
</td>
<td style="width:200%;" colspan="2">
<form action="registrations.php" method="post" align="center" style="width:100%;">
    <select name="branch" onchange="javascript:setTimeout(&#39;__doPostBack(\&#39;coursePref3\&#39;,\&#39;\&#39;)&#39;, 0)" id="coursePref3" class="comboExtraLarge" style="height:24px;width:192px;">
...
<td><?php echo $row['email'];?></td>
 ...
 <?php $data="<script>document.write(excel_data);</script>";?>
		<form method = "GET" action = "excel.php">
				<input type="hidden" name="excel" value="<?php echo $_POST['branch']; ?>">
				<div align="center">  
