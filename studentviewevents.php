...
$search_result='';
    ...
    $query = "SELECT * FROM addevent WHERE branch LIKE '%".$_SESSION['branch']."%'";
...
<td>
<form action="eventinfo.php" method="post" align="center" style="width:100%;">
...
<input type = "hidden" name = "eventdesc" id = "eventdesc" value = "<?php echo $row['eventdesc']; ?>">
<input type = "hidden" name = "eventtype" id = "eventtype" value = "<?php echo $row['eventtype']; ?>">
<input type="submit" name = "register" value = "View Event">
</form>
</td>
</tr>
                <?php }
