...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM addevent WHERE eventid LIKE '%$eventid%'";
...
<form action="viewevents.php" method="post" align="center" style="width:100%;">
            <input type="text" name="eventid" placeholder="Enter EventID">
...
<td><?php echo $row['eventdesc'];?></td>
 ...
 <?php $data="<script>document.write(excel_data);</script>";?>
		<form method = "POST" action = "excel1.php">
				...
				<input type="hidden" name="excel_name" value="<?php echo $_POST['eventname']; ?>">
				<div align="center">  
